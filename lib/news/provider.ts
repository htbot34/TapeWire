import type { NewsItem, UserFilters } from "./types";
...
export interface NewsProvider {
  ...
  /** Ranked digest of the overnight session, most important first. */
  getOvernightBriefing(filters: UserFilters): Promise<NewsItem[]>;
