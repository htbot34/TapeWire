...
const seeds: Seed[] = [
  // ───────────────────────── intraday tape (0–2h) ─────────────────────────
  {
    ...
    source: "Reuters",
    sourceType: "wire",
    latency: "received 1.2s after publish",
    sourceVerified: true,
    impact: "high",
    scheduled: true,
  ...
  },
  {
    ...
    source: "Reuters",
    sourceType: "wire",
    latency: "received 0.9s after publish",
    sourceVerified: true,
    impact: "medium",
    scheduled: false,
    directTickers: ["NVDA"],
  ...
  },
  {
    ...
    source: "CNBC",
    sourceType: "outlet",
    latency: "received 4s after publish",
    sourceVerified: true,
    impact: "low",
    scheduled: false,
    directTickers: ["TLT"],
  ...
  },
  {
    ...
    source: "@DeItaone",
    sourceType: "social",
    latency: "received 2.1s after post",
    ...
    correctedAt: ts(4),
    correction:
      "CORRECTION: the SAMR filing covers 1.2 million vehicles, not 1.1 million as first posted. The original headline is preserved above — TapeWire never silently rewrites source headlines.",
    marketReaction: [
  ...
  },
  {
    ...
    impact: "medium",
    scheduled: true,
    econ: { actual: "-2.8M bbl", forecast: "-1.2M bbl", previous: "-3.4M bbl" },
    directTickers: ["USO"],
  ...
  },
  {
    ...
    source: "Bloomberg",
    sourceType: "outlet",
    latency: "received 6s after publish",
    sourceVerified: true,
    impact: "low",
    scheduled: false,
    directTickers: [],
  ...
  },
  {
    ...
    source: "Reuters",
    sourceType: "wire",
    latency: "received 1.6s after publish",
    sourceVerified: true,
    impact: "medium",
    scheduled: false,
    directTickers: ["META"],
  ...
  },
  {
    ...
    source: "ForexLive",
    sourceType: "outlet",
    latency: "received 3s after publish",
    sourceVerified: true,
    impact: "low",
    scheduled: false,
    directTickers: [],
  ...
  },
  {
    ...
    source: "Reuters",
    sourceType: "wire",
    latency: "received 1.4s after publish",
    sourceVerified: true,
    impact: "low",
    scheduled: false,
    directTickers: ["SPY"],
  ...
  },
  {
    ...
    sourceType: "wire",
    latency: "detected 2.1s after move start",
    sourceVerified: true,
    impact: "medium",
    scheduled: false,
    directTickers: ["NQ"],
  ...
  },
  {
    ...
    sourceType: "social",
    latency: "received 1.8s after post",
    sourceVerified: false,
    impact: "low",
    scheduled: false,
  ...
  },
  {
    ...
    source: "US Treasury",
    sourceType: "econ-calendar",
    latency: "received 0.6s after release",
    sourceVerified: true,
    impact: "medium",
    scheduled: true,
    econ: { actual: "b/c 2.42", previous: "b/c 2.55" },
    directTickers: ["TLT"],
    correlatedTickers: [],
    assetClasses: ["futures", "equities"],
    eventType: "econ-release",
  ...
  // ──────────────────────── pre-market block (2–5h) ────────────────────────
  {
    ...
    source: "BLS",
    sourceType: "econ-calendar",
    latency: "received 1.1s after release",
    sourceVerified: true,
    impact: "high",
    scheduled: true,
    econ: { actual: "+0.2% m/m", forecast: "+0.3% m/m", previous: "+0.1% m/m" },
  ...
  },
  {
    ...
    source: "DOL",
    sourceType: "econ-calendar",
    latency: "received 0.9s after release",
    sourceVerified: true,
    impact: "medium",
    scheduled: true,
    econ: { actual: "219K", forecast: "225K", previous: "222K" },
    directTickers: ["SPY"],
    correlatedTickers: [],
    assetClasses: ["equities", "futures"],
    eventType: "econ-release",
  ...
  },
  {
    ...
    impact: "high",
    scheduled: true,
    econ: { actual: "EPS $4.87", forecast: "EPS $4.61", previous: "EPS $4.72" },
    directTickers: ["JPM"],
  ...
  },
  {
    ...
    impact: "medium",
    scheduled: true,
    econ: { actual: "3.1% y/y", forecast: "2.9% y/y", previous: "3.0% y/y" },
    directTickers: [],
    correlatedTickers: [],
    assetClasses: ["forex"],
  ...
  },
  {
    ...
    impact: "low",
    scheduled: true,
    econ: { actual: "-2.1% m/m", forecast: "+0.5% m/m", previous: "-1.4% m/m" },
    directTickers: [],
    correlatedTickers: [],
    assetClasses: ["forex", "futures"],
    pairs: ["EUR/USD"],
  ...
  // ───────────────────────── overnight session (5–16h) ─────────────────────────
  {
    ...
    impact: "high",
    scheduled: true,
    econ: { actual: "+38% y/y", forecast: "+31% y/y", previous: "+35% y/y" },
    directTickers: ["TSM"],
  ...
  },
  {
    ...
    source: "@zerohedge",
    sourceType: "social",
    latency: "received 2.6s after post",
    sourceVerified: false,
    impact: "low",
    scheduled: false,
    directTickers: ["ZIM"],
  ...
  },
  {
    ...
    impact: "medium",
    scheduled: true,
    econ: { actual: "+7.6% y/y", forecast: "+5.0% y/y", previous: "+4.8% y/y" },
    directTickers: ["FXI"],
  ...
  },
  {
    ...
    impact: "medium",
    scheduled: true,
    econ: { actual: "3.60%", forecast: "3.35%", previous: "3.60%" },
    directTickers: [],
    correlatedTickers: [],
    assetClasses: ["forex"],
    pairs: ["AUD/USD"],
  ...
  },
  {
    ...
    impact: "low",
    scheduled: true,
    econ: { actual: "2.9% y/y", forecast: "2.7% y/y", previous: "2.6% y/y" },
    directTickers: [],
    correlatedTickers: [],
    assetClasses: ["forex"],
    pairs: ["NZD/USD"],
  ...
  },
  {
    ...
    impact: "low",
    scheduled: true,
    econ: { actual: "50.4", forecast: "50.1", previous: "49.7" },
    directTickers: [],
    correlatedTickers: [],
    assetClasses: ["forex", "futures"],
    pairs: ["EUR/USD"],
...
export const breakingPool: BreakingSeed[] = [
  ...
  },
  {
    ...
    impact: "high",
    scheduled: true,
    econ: { actual: "+310K", forecast: "+160K" },
    directTickers: ["SPY", "QQQ", "TLT", "GLD"],
    correlatedTickers: [],
    assetClasses: ["equities", "options", "futures", "forex"],
    pairs: ["EUR/USD", "USD/JPY"],
